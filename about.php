    ...
    <body>
        ...
        <div id="canvas">
            <div id="box_wrapper">
                ...
                <section class="ls c-gutter-0 container-px-0">
                    <div class="container-fluid">
                        <div class="row">
                ...
                <section class="ls s-py-90 s-py-xl-150 about-2 leaf-wrap">
                    <div
                        ...
                        data-delay="150"
                    >
                        <img src="images/about-leaf-2.png" alt="img" />
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="collapse_shortcode">
                                    <div class="collapse_shortcode-item">
                                        <div
                                            class="collapse_shortcode-item-title"
                                        >
                                            <h4>
                                                <a
                                        ...
                                        <div
                                            class="collapse_shortcode-item-content collapse multi-collapse show"
                                    ...
                                    <div class="collapse_shortcode-item">
                                        ...
                                        <div
                                            class="collapse_shortcode-item-content multi-collapse collapse show"
                ...
                <section
                    id="steps"
                    class="ls s-py-90 s-py-xl-150 c-gutter-80 leaf-wrap overflow-visible with-leaf-2 parallax"
                >
