...
(function ($) {
    ...
    function menuHideExtraElements() {
        ...
        $(".sf-menu").each(function () {
            ...
            if (windowWidth > 1199) {
                ...
                var $headerLogoCenter = $thisMenu.closest(
                    ".header_logo_center"
                );
                var logoWidth = 0;
                ...
                if ($headerLogoCenter.length) {
                    ...
                    var liLeftRightDotX =
                        $liLeftFromLogo.offset().left +
                        $liLeftFromLogo.outerWidth();
            ...
            setTimeout(function () {
                ...
                if (windowWidth > 991) {
                    $megaMenu.each(function () {
                        ...
                        var thisOffset =
                            $thisMegaMenu.offset().left -
                            stickedSideHeaderWidth;
                        var thisLeft =
                            thisOffset + thisWidth / 2 - windowWidth / 2;
    ...
    function initAffixSidebar() {
        ...
        if ($affixAside.length) {
            ...
            var offsetTop =
                $affixAside.offset().top - $(".page_header").height();
    ...
    function Parallax(options) {
        ...
        this.init = function () {
            ...
            for (var i = 0; i < parallaxWrappers.length; i++) {
                (function (i) {
                    parallaxWrappers[i].addEventListener(
                        "mousemove",
                        function (e) {
                            var x = e.clientX,
                                y = e.clientY,
    ...
    function toggleBtnForShop() {
        if (document.querySelector(".products-selection")) {
            ...
            let changeClassFromTo = (self, from, to) => {
                self.closest(".products-selection")
                    .next()
                    .removeClass(from)
                    .addClass(to);
            };
    ...
    function quantity_init() {
        ...
        $numberInput.before(
            '<input type="button" value="+" class="plus"><i class="ico-chevron-down rotate" aria-hidden="true"></i>'
        );
        $numberInput.after(
            '<input type="button" value="-" class="minus"><i class="ico-chevron-down" aria-hidden="true"></i>'
        );
    ...
    function flexSliderCountNav() {
        ...
        let prevNavCounter = nav
            .querySelector(".flex-prev")
            .querySelector(".flex-counter");
        let nextNavCounter = nav
            .querySelector(".flex-next")
            .querySelector(".flex-counter");
        let slider = nav.closest(".page_slider").querySelector(".flexslider");
        let slidesLength = slider.querySelectorAll(".slide").length;
        let index = [...slider.querySelectorAll(".slide")].findIndex(function (
            item
        ) {
                ...
                if (MainWindowWidth > 991) {
                    ...
                    if (subMenuExist > 0) {
                        var subMenuWidth = $this
                            ...
                            .width();
                        var subMenuOffset =
                            $this.find("ul, div").first().parent().offset()
                                .left + subMenuWidth;
    ...
    function windowLoadInit() {
        ...
        if ($().owlCarousel) {
            $(".owl-carousel").each(function () {
                ...
                var loop = data.loop ? data.loop : false,
                    margin =
                        data.margin || data.margin === 0 ? data.margin : 30,
                ...
                if (
                    $carousel.hasClass("owl-news-slider-items") &&
                    syncedClass
                ) {
        ...
        if ($().spectragram) {
            var Spectra = {
                instaToken:
                    "3905738328.60c782d.b65ed3f058d64e6ab32c110c6ac12d9b",
            ...
            if ($filters.length) {
                $filters.on("click", "a", function (e) {
                    ...
                    boxs.forEach(function (box) {
                        ...
                        filterValue === "*" ||
                        box.classList.contains(filterValue.slice(1))
                            ? toggle()
                            : true;
                    });
                });
...
let arabic = document.querySelector("arabic")[0];
let english = document.querySelector("english")[0];
