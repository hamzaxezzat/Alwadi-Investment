    ...
    <body>
        ...
        <div id="canvas">
            <div id="box_wrapper">
                ...
                <section class="ls s-py-90 s-py-xl-150 c-gutter-60">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <article class="post side-item content-padding">
                                    <div class="row">
                                        <div class="col-md-6 leaf-wrap">
                                            <div class="item-media cover-img">
                                                <img
                                            ...
                                            <div
                                                class="leaf leaf-right animate h-100"
                                                data-animation="fadeInLeft"
                                                data-delay="150"
                                            >
                                                <img
                                                    class="h-100"
                                                    src="images/event-leaf-1.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            class="col-md-6 d-md-flex align-center"
                                        >
                                            <div
                                                class="item-content big-content pe-0"
                                            >
                                                <div
                                                    class="divider-40 divider-md-0"
                                                ></div>
                                                <div class="service-icon">
                                                    <i class="ico-wind-big"></i>
                                                </div>
                                                <h2 class="mt-0">
                                                    <a
                                                        href="service-single.html"
                                ...
                                <article class="post side-item content-padding">
                                    <div class="row">
                                        <div
                                            class="col-md-6 leaf-wrap order-md-1"
                                        >
                                            <div class="item-media cover-img">
                                                <img
                                            ...
                                            <div
                                                class="leaf leaf-left animate h-100"
                                        ...
                                        <div
                                            class="col-md-6 d-md-flex align-center order-md-0"
                                        >
                                            <div
                                                class="item-content big-content ps-0"
                                            >
                                                <div
                                                    class="divider-40 divider-md-0"
                                                ></div>
