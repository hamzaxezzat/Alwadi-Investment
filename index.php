                ...
                <div class="row align-items-center">
                    <div class="col-12 d-flex">
                        ...
                        <div>
                            <div
                                id="topline_dropdown"
                                class="dropdown meta-dropdown"
                            >
                                <span
                                    id="toplineDropdown"
                                    class="nav-btn type-dots dark"
                                ...
                                <ul
                                    ...
                                    aria-labelledby="toplineDropdown"
                                >
            ...
            <div id="box_wrapper">
                ...
                <section class="intro_section page_slider line-gradient">
                    <div class="flexslider">
                        ...
                        >
                            <li
                                class="slide cover-image ds text-center s-overlay"
                            >
                            ...
                            <li
                                class="slide cover-image ds text-center s-overlay s-overlay-dark"
                            >
                            ...
                            <li
                                class="slide cover-image ds text-center s-overlay s-overlay-dark"
                            >
                                <img src="images/slide04.jpg" alt="img" />
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="intro_layers">
                        ...
                        <a href="#" class="flex-prev">
                            ...
                            >
                                <g clip-path="url(#clip0)">
                                    <path
                                        d="M49.5 5C29.9738 5 20.0262 5 0.5 5L4.5 1"
                                        stroke="white"
                        ...
                        <a href="#" class="flex-next">
                            ...
                            >
                                <g clip-path="url(#clip1)">
                                    <path
                                        d="M0.5 5C20.0262 5 29.9738 5 49.5 5L45.5 9"
                                        stroke="white"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                    />
                                ...
                                <defs>
                                    <clipPath id="clip1">
                                        <rect
                                            width="50"
                                            height="9"
                                            transform="translate(50 9.5) rotate(-180)"
                                        />
                                    </clipPath>
                                </defs>
                            </svg>
                            ...
                            <div class="col-md-6 col-xl-3">
                                ...
                                >
                                    <a href="blogs.html">
                                        ...
                                        >
                                            <i
                                                class="ico-wind fs-64 text-white"
                                            ></i>
                                            <h3
                            ...
                            <div class="col-md-6 col-xl-3">
                                ...
                                >
                                    <a href="blogs.html">
                                        ...
                                        >
                                            <i
                                                class="ico-water fs-64 text-white"
                                            ></i>
                                            <h3
                                                class="mt-2 mb-0 text-uppercase"
                                            >
                            ...
                            <div class="col-md-6 col-xl-3">
                                ...
                                >
                                    <a href="blogs.html">
                                        ...
                                        >
                                            <i
                                                class="ico-sun fs-64 text-white"
                                            ></i>
                                            <h3
                                                class="mt-2 mb-0 text-uppercase"
                                            >
                            ...
                            <div class="col-md-6 col-xl-3">
                                ...
                                >
                                    <a href="blogs.html">
                                        ...
                                        >
                                            <i
                                                class="ico-flame fs-64 text-white"
                                            ></i>
                                            <h3
                                                class="mt-2 mb-0 text-uppercase"
                                            >
                        ...
                        <div class="row align-center">
                            <div class="col-lg-5 col-xl-5 offset-xl-1">
                                <div class="img-shortcode leaf-wrap">
                                    <div
                                        class="leaf leaf-left about-1 animate animated"
                                        data-animation="fadeInRight"
                                        data-delay="150"
                                    >
                                        <img
                                            src="images/img-leaf-1.png"
                                            alt="img"
                                        />
                                    </div>
                                    <div
                                        class="leaf leaf-right about-1 animate animated"
                                        data-animation="fadeInLeft"
                                        data-delay="150"
                                    >
                                        <img
                                            src="images/img-leaf-2.png"
                                            alt="img"
                                        />
                                    </div>
                                    <div
                                    ...
                                    <img src="images/events/34.jpg" alt="img" />
                                </div>
                            </div>
                            <div
                                class="col-lg-6 offset-lg-1 col-xl-4 offset-xl-2"
                            >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-02.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-04.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-06.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-07.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-01.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-05.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-08.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="vertical-item content-half-padding">
                                    <div class="item-media">
                                        <img
                                            src="images/events/Gallery-03.jpg"
                                            alt="img"
                                        />
                                        <div class="media-links">
                                            <a class="default-link"></a>
                ...
                >
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div
                                    class="divider-60 divider-lg-0 divider-xl-80"
                                ></div>
                                <div class="icon-box">
                                    <h5 class="mb-3 position-relative">
                            ...
                            <div
                                class="col-xl-4 col-lg-6 me-md-auto ms-md-auto"
                            >
                            ...
                            <main class="col-12">
                                <div class="row c-mb-80 c-gutter-40">
                                    <div class="col-xl-4 col-md-6">
                                        <article
                                            class="vertical-item content-half-padding post sticky type-post status-publish format-standard has-post-thumbnail"
                                        >
                                            <div
                                                class="item-media cover-img-full"
                                            >
                                                <img
                                                    src="images/events/service-1.jpg"
                                                    alt="img"
                                                />
                                                <div class="media-links">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <article
                                            class="vertical-item content-half-padding post type-post status-publish format-standard has-post-thumbnail"
                                        >
                                            <div
                                                class="item-media cover-img-full"
                                            >
                                                <img
                                                    src="images/events/service-2.jpg"
                                                    alt="img"
                                                />
                                                <div class="media-links">
                                                    <div class="links-wrap">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <article
                                            class="vertical-item content-half-padding post post_format-post-format-video type-post status-publish format-standard has-post-thumbnail"
                                        >
                                            <div
                                                class="item-media cover-img-full"
                                            >
                                                <img
                                                    src="images/events/service-3.jpg"
                                                    alt="img"
                                                />
                                                <div class="media-links">
                                                    <div class="links-wrap">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="images/events/service-4.jpg"
                                                    alt="image"
                                                />
                                                <div class="media-links">
                                                    <div class="links-wrap">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="images/events/service-5.jpg"
                                                    alt="img"
                                                />
                                                <div class="media-links">
                                                    <div class="links-wrap">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="images/events/service-6.jpg"
                                                    alt="img"
                                                />
                                                <div class="media-links">
                                                    <div class="links-wrap">
                                ...
                                <div id="accordion03" role="tablist">
                                    <div class="card">
                                        ...
                                        <div
                                            ...
                                            class="collapse"
                                            role="tabpanel"
                                            aria-labelledby="collapse12_header"
                                    ...
                                    <div class="card">
                                        ...
                                        <div
                                            ...
                                            class="collapse"
                                            role="tabpanel"
                                            aria-labelledby="collapse13_header"
                                            data-bs-parent="#accordion03"
                                        >
                                            <div class="card-body">
                                                <p>
                                    ...
                                    <div class="card">
                                        ...
                                        <div
                                            ...
                                            class="collapse"
                                            role="tabpanel"
                                            aria-labelledby="collapse14_header"
                                            data-bs-parent="#accordion03"
                                        >
                                            <div class="card-body">
                                                <p>
                                    ...
                                    <div class="card">
                                        ...
                                        <div
                                            ...
                                            class="collapse"
                                            role="tabpanel"
                                            aria-labelledby="collapse15_header"
                                            data-bs-parent="#accordion03"
                                        >
                                            <div class="card-body">
                                                <p>
                                    ...
                                    <div class="card">
                                        ...
                                        <div
                                            ...
                                            class="collapse"
                                            role="tabpanel"
                                            aria-labelledby="collapse16_header"
                                            data-bs-parent="#accordion03"
                                        >
                                            <div class="card-body">
                                                <p>
                    ...
                    >
                        <div class="container">
                            <div class="row">
                                ...
                                >
                                    <div
                                        class="widget widget_nav_menu side_menu"
                                    >
                                        <ul class="menu">
                                            <li>
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-12 text-center">
                                    <p class="color-dark">
                                        Copyright &copy;
                                        <span class="copyright_year">2022</span>
                                        All Rights Reserved
                                    </p>
                                </div>
                            </div>
